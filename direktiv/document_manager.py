...
class DocumentManager:
    ...
    def __init__(
        self, library_path: Optional[Path] = None, show_dotfiles: bool = False
    ):
    ...
    def add_document(
        self, source_path: Path, category: str = "General", title: Optional[str] = None
    ...
    def list_documents(self, category: Optional[str] = None) -> List[Dict[str, str]]:
        ...
        return sorted(documents, key=lambda x: (x["category"], x["name"]))  # type: ignore[arg-type]

    def move_document(self, document_path: Path, new_category: str) -> Tuple[bool, str]:
    ...
    def import_directory(
        self, source_dir: Path, category: Optional[str] = None, recursive: bool = True
    ...
    def get_library_stats(self) -> Dict[str, int]:
        ...
        stats["total_size_mb"] = int(round(stats["total_size_bytes"] / (1024 * 1024), 2))
